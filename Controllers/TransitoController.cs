...
{
    private readonly ITransitoService _service;
    public TransitoController(ITransitoService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] TransitoCrearDto dto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, [FromBody] TransitoCrearDto dto)
    {
